...
\hypersetup{
 ...
 pdfkeywords={},
 pdfsubject={},
 pdfcreator={Emacs 30.0.92 (Org mode 9.8-pre)},
 pdflang={French}}
...
\section*{Composants}
\label{sec:org09d36df}
\subsection*{Polices}
\label{sec:org4dbc465}
...
\caption{\label{fig:orgce88126}Palette d'évidence}
\end{figure}
...
\caption{\label{fig:org692b071}Palette binaire}
\end{figure}
...
\caption{\label{fig:orgda08e7e}Palette Séquencielle}
\end{figure}
...
\caption{\label{fig:org1f369fe}Palette de Classement}
\end{figure}

Cette palette de couleur est utilisée pour encodé les variations des positions relatives des catégories. La variation s'effectue sur la saturation de la couleur contrairement à la palette \ref{fig:orgda08e7e} qui varie sur la luminosité.

\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{./img/palette-thermique.pdf}
\caption{\label{fig:org95bc239}Palette thermique}
\end{figure}
...
\caption{\label{fig:org08aded0}Palette divergente}
\end{figure}
...
\caption{\label{fig:org44290d2}Palette catégorique}
\end{figure}
...
\caption{\label{fig:orgdb33d07}Palette arc-en-ciel}
\end{figure}

Palette de couleur à prohiber.\autocite{wilkeCommonPitfallsColor2019}
\subsection*{Graphiques}
\label{sec:org40567f3}
Pour qu'un graphique s'intègre correctement dans un document, il convient de prévoir une zone de protection. Dans la figure \ref{fig:org410d040} nous proposons un exemple de protection relative aux largeurs des marges latérales.

\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{./img/general-graphics-rules.pdf}
\caption{\label{fig:org410d040}Zones de protection d'un graphique}
\end{figure}
\subsubsection*{Cadre}
\label{sec:org64ef38c}
Les lignes d'ages
...
\subsubsection*{Ligne}
\label{sec:org40a655d}
Les lignes sont à différencier les unes des autres en utilisant les méthodologies décrites dans la section \hyperref[sec:org4086689]{Couleurs}. Il est possible de surimposer des points de repères lorsque diverses valeurs sont à comparer pour un temps donné. \autocite{stephenfewComponentlevelGraphDesign2012}
...
\caption{\label{fig:org6ab125a}Contenu type d'un texte alternatif selon l'usage concerné}
\end{figure}
...
La seconde direction est de filtrer les types de graphiques en fonction de l'objectif de l'utilisateur. Nous avons poursuivi notre étude dans ce sens. La figure \ref{fig:org196c7cc} propose une discrimination des types de représentations en identifiant l'objectif recherché par l'utilisateur.

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-filter.pdf}
\caption{\label{fig:org196c7cc}Parcours de sélection}
\end{figure*}
...
\label{sec:orgf6ae7a5}
\subsection*{Indicateur}
\label{sec:org61fb8e8}
\subsubsection*{Marqueur}
\label{sec:org9b51c61}
...
\label{sec:orge41c1ba}
\subsubsection*{Camembert}
\label{sec:orge713480}
...
Dans le cas ou une seule partie de l'ensemble est mise en avant, il est à considérer l'utilisation d'un \hyperref[sec:org9b51c61]{Marqueur}. Le camembert n'apportant aucune information particulière à votre propos.
...
Il est, autrement, en tout point similaire aux \hyperref[sec:orge713480]{Camembert}
\subsubsection*{Quadrillage}
\label{sec:org7c8405d}
...
\label{sec:orgcede7d9}
\subsubsection*{Barre ordonnée}
\label{sec:org4f8c639}
...
\caption{\label{fig:orgb49cb1f}Composition d'une matrice de graphique}
\end{figure}
\subsection*{Distribution}
\label{sec:orge0af4a1}
\subsubsection*{Courbe de densité}
\label{sec:org51d621e}
...
L'utilisation d'un histogramme permet d'identifier des schémas de distributions tels que définis dans la figure \ref{fig:org02a1ea2}. \autocite{jonathanschwabishDistribution2021}
...
\caption{\label{fig:org02a1ea2}Illustration des formes remarquables d'un histogramme}
\end{figure}

L'histogramme n'est pas adapté aux cas suivant :
\begin{itemize}
\item l'affichage de l'ensemble des valeurs, pour cela il convient d'utiliser une \hyperref[sec:org51d621e]{Courbe de densité}. \autocite{wilkeVisualizingDistributionsHistograms2019}
\item s'il y a peu de valeurs dans le jeu de données, \autocite{weissgerberBarLineGraphs2015} préférez l'utilisation d'une \hyperref[sec:orga03d563]{Bande de valeur}.
\item l'affichage de plusieurs distributions,\autocite{wilkeVisualizingDistributionsHistograms2019} utilisez une décomposition en \hyperref[sec:org2bcf69d]{Matrice de graphique}.
\end{itemize}
\subsubsection*{Valeur lettrée}
\label{sec:orgebdf448}
...
\label{sec:org90832d1}
\subsubsection*{Jauge}
\label{sec:org23210a8}
...
Pour tout autre usage, et considérant la difficulté humaine d'interprétation d'une valeur en comparant des angles ainsi que le manque d'options pertinentes pour ajouter des informations qualitatives sur les jauges, il convient d'utiliser un graphique en \hyperref[sec:org86eed12]{Tiret}.
\subsubsection*{Ruisseau}
\label{sec:org747cd5e}
...
\item Ces cas échouant, séparez les lignes et tracez une \hyperref[sec:org2bcf69d]{Matrice de graphique}.
\end{itemize}
...
\label{sec:orgc6bb599}
\subsubsection*{Pareto}
\label{sec:org5c6cbe9}
...
\label{sec:orgb453704}

Représente la relation entres deux variables continues. \autocite{alansmithLexiqueVisuel}
La couleur est la meilleure façon de distinguer les catégories.\autocite{stephenfewComponentlevelGraphDesign2012} Pour cela, utilisez la pallette catégorique (\ref{fig:org44290d2})
...
\caption{\label{fig:org7dc324b}Formes des points de données}
\end{figure}
...
Ce graphique utilise les couleurs de la palette thermique \ref{fig:org95bc239}.
...
\label{sec:orgcecfa7f}
\subsubsection*{Alluvial}
\label{sec:orgdbf0e01}
...
De cette étude, nous avons extrait des éléments généraux et d'autres pouvant faire l'objet d'un choix de personnalisation de l'utilisateur. Le tableau \ref{tab:orgfd15d7d} les identifies.

\begin{table*}[htbp]
\caption{\label{tab:orgfd15d7d}Résumé des attentes utilisateurs}
\centering
\begin{tabular}{rlll}
