...
\captionof{figure}{\label{fig:org092470b}Palette d'évidence}
\end{center}
...
\captionof{figure}{\label{fig:org36c1e01}Palette binaire}
\end{center}
...
\captionof{figure}{\label{fig:orge27518b}Palette Séquencielle}
\end{center}
...
\captionof{figure}{\label{fig:org8a17fa4}Palette de Classement}
\end{center}
...
\captionof{figure}{\label{fig:org5a9cc75}Palette thermique}
\end{center}
...
\captionof{figure}{\label{fig:org47bed4e}Palette divergente}
\end{center}
...
\captionof{figure}{\label{fig:orgd52b149}Palette catégorique}
\end{center}
...
\captionof{figure}{\label{fig:org79d4251}Palette arc-en-ciel}
\end{center}
...
\captionof{figure}{\label{fig:org9ccf255}Zones de protection d'un graphique}
\end{center}
\subsubsection{Cadre}
...
\captionof{figure}{\label{fig:org544a1e5}Contenu type d'un texte alternatif selon l'usage concerné}
\end{center}
...
\captionof{figure}{\label{fig:org66cb243}Composition d'une matrice de graphique}
\end{center}
...
\captionof{figure}{\label{fig:orgc1521fe}Illustration des formes remarquables d'un histogramme}
\end{center}
...
\captionof{figure}{\label{fig:orgd911288}Formes des points de données}
\end{center}
