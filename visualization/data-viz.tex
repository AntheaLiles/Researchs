...
\section*{Composants}
\label{sec:org003c270}
\subsection*{Polices}
\label{sec:orgdba3ee1}
...
\caption{\label{fig:org5fe9f1f}Palette d'évidence}
\end{figure}
...
\caption{\label{fig:org13f0d89}Palette binaire}
\end{figure}
...
\caption{\label{fig:orgf29a0c3}Palette Séquencielle}
\end{figure}
...
\caption{\label{fig:orgf317093}Palette de Classement}
\end{figure}

Cette palette de couleur est utilisée pour encodé les variations des positions relatives des catégories. La variation s'effectue sur la saturation de la couleur contrairement à la palette \ref{fig:orgf29a0c3} qui varie sur la luminosité.

\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{./img/palette-thermique.pdf}
\caption{\label{fig:orgc22fec7}Palette thermique}
\end{figure}
...
\caption{\label{fig:orgb1a5416}Palette divergente}
\end{figure}
...
\caption{\label{fig:org4290d5e}Palette catégorique}
\end{figure}
...
\caption{\label{fig:org3ea0f69}Palette arc-en-ciel}
\end{figure}

Palette de couleur à prohiber.\autocite{wilkeCommonPitfallsColor2019}
\subsection*{Graphiques}
\label{sec:org6157eaa}
Pour qu'un graphique s'intègre correctement dans un document, il convient de prévoir une zone de protection. Dans la figure \ref{fig:org9e49799} nous proposons un exemple de protection relative aux largeurs des marges latérales.

\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{./img/general-graphics-rules.pdf}
\caption{\label{fig:org9e49799}Zones de protection d'un graphique}
\end{figure}
\subsubsection*{Cadre}
\label{sec:orge78fe8a}
Les lignes d'ages
...
\subsubsection*{Ligne}
\label{sec:org88997f8}
Les lignes sont à différencier les unes des autres en utilisant les méthodologies décrites dans la section \hyperref[sec:org20942cf]{Couleurs}. Il est possible de surimposer des points de repères lorsque diverses valeurs sont à comparer pour un temps donné. \autocite{stephenfewComponentlevelGraphDesign2012}
...
\caption{\label{fig:orgcd5df7f}Contenu type d'un texte alternatif selon l'usage concerné}
\end{figure}
...
La seconde direction est de filtrer les types de graphiques en fonction de l'objectif de l'utilisateur. Nous avons poursuivi notre étude dans ce sens. La figure \ref{fig:orgfddfb8c} propose une discrimination des types de représentations en identifiant l'objectif recherché par l'utilisateur.

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./img/select-filter.pdf}
\caption{\label{fig:orgfddfb8c}Parcours de sélection}
\end{figure*}
...
\label{sec:orgc1b6bb6}
\subsection*{Indicateur}
\label{sec:orgb777bf0}
\subsubsection*{Marqueur}
\label{sec:org6c85a04}
...
\label{sec:orgcd51540}
\subsubsection*{Camembert}
\label{sec:org656162c}
...
Dans le cas ou une seule partie de l'ensemble est mise en avant, il est à considérer l'utilisation d'un \hyperref[sec:org6c85a04]{Marqueur}. Le camembert n'apportant aucune information particulière à votre propos.
...
Il est, autrement, en tout point similaire aux \hyperref[sec:org656162c]{Camembert}
\subsubsection*{Quadrillage}
\label{sec:org859eccb}
...
\label{sec:org2964624}
\subsubsection*{Barre ordonnée}
\label{sec:org7e17960}
...
\caption{\label{fig:org84ecc9c}Composition d'une matrice de graphique}
\end{figure}
\subsection*{Distribution}
\label{sec:org50c887c}
\subsubsection*{Courbe de densité}
\label{sec:org8cfca68}
...
L'utilisation d'un histogramme permet d'identifier des schémas de distributions tels que définis dans la figure \ref{fig:orgb6cb76a}. \autocite{jonathanschwabishDistribution2021}
...
\caption{\label{fig:orgb6cb76a}Illustration des formes remarquables d'un histogramme}
\end{figure}

L'histogramme n'est pas adapté aux cas suivant :
\begin{itemize}
\item l'affichage de l'ensemble des valeurs, pour cela il convient d'utiliser une \hyperref[sec:org8cfca68]{Courbe de densité}. \autocite{wilkeVisualizingDistributionsHistograms2019}
\item s'il y a peu de valeurs dans le jeu de données, \autocite{weissgerberBarLineGraphs2015} préférez l'utilisation d'une \hyperref[sec:org021a67b]{Bande de valeur}.
\item l'affichage de plusieurs distributions,\autocite{wilkeVisualizingDistributionsHistograms2019} utilisez une décomposition en \hyperref[sec:org1dd6356]{Matrice de graphique}.
\end{itemize}
\subsubsection*{Valeur lettrée}
\label{sec:org57400c1}
...
\label{sec:org2238e36}
\subsubsection*{Jauge}
\label{sec:orgc587143}
...
Pour tout autre usage, et considérant la difficulté humaine d'interprétation d'une valeur en comparant des angles ainsi que le manque d'options pertinentes pour ajouter des informations qualitatives sur les jauges, il convient d'utiliser un graphique en \hyperref[sec:org59e5a3a]{Tiret}.
\subsubsection*{Ruisseau}
\label{sec:orgf93e533}
...
\item Ces cas échouant, séparez les lignes et tracez une \hyperref[sec:org1dd6356]{Matrice de graphique}.
\end{itemize}
...
\label{sec:org90fbab8}
\subsubsection*{Pareto}
\label{sec:orga9983fe}
...
\label{sec:orgfcf7bdf}

Représente la relation entres deux variables continues. \autocite{alansmithLexiqueVisuel}
La couleur est la meilleure façon de distinguer les catégories.\autocite{stephenfewComponentlevelGraphDesign2012} Pour cela, utilisez la pallette catégorique (\ref{fig:org4290d5e})
...
\caption{\label{fig:orgddc4001}Formes des points de données}
\end{figure}
...
Ce graphique utilise les couleurs de la palette thermique \ref{fig:orgc22fec7}.
...
\label{sec:org272903c}
\subsubsection*{Alluvial}
\label{sec:org67e0323}
...
De cette étude, nous avons extrait des éléments généraux et d'autres pouvant faire l'objet d'un choix de personnalisation de l'utilisateur. Le tableau \ref{tab:org9219b1a} les identifies.

\begin{table*}[htbp]
\caption{\label{tab:org9219b1a}Résumé des attentes utilisateurs}
\centering
\begin{tabular}{rlll}
