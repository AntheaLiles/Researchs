...
#+PROPERTY: header-args:R :results output graphics :exports results
...
#+NAME: db-ranking-graph
#+CAPTION: Tendances DB-Engine Ranking pour Oracle, MySQL, et PostgreSQL
#+BEGIN_SRC R :file charts/top5.pdf :width 10 :height 6 :exports results :results graphics
library(readr)
library(dplyr)
library(ggplot2)
