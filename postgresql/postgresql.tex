...
\label{sec:org95e740e}
\subsection*{Extensions multi-modèles}
\label{sec:org26d4019}
...
\caption{\label{fig:orgce023fb}Logos : PostGIS, pgRouting, MobilityDB, H3, GISWater}
\end{figure}
...
\caption{\label{fig:org12e785b}Logos : Apache AGE, FerretDB, pg\_duck, Marten, Pongo}
\end{figure}
...
\label{sec:org67543d5}
\subsection*{Compatibilité}
\label{sec:orgd757236}
\begin{quote}
...
\label{sec:org0a50383}
\subsection*{Conformité et audit}
\label{sec:org9a1e11b}
\begin{description}
...
\caption{\label{fig:org42c4f43}Logos : PGCat, pgBouncer, pgPool-II}
\end{figure}
...
\label{sec:org4b18ed5}
\subsection*{Mise en production}
\label{sec:orgbc16795}
\begin{table}[H]
...
\caption{\label{fig:org37aeea3}Logos : Tembo, Neon, Supabase, Autobase, Omnigress}
\end{figure}
...
\caption{\label{fig:orgcc4c695}Logos : Gel, pgEdge, Pigsty, iaSQL,}
\end{figure}
\subsection*{Analyse de compétitive}
\label{sec:org4bcbbbd}
...
\label{sec:orga2c2f8a}
\section*{Evolution du document}
\label{sec:org4e8c22b}
\begin{center}
\begin{tabular}{rl}
Date & Changements\\
\hline
