...
\caption{\label{fig:org62c928e}Logos : PostGIS, pgRouting, MobilityDB, H3, GISWater}
\end{figure}
...
\caption{\label{fig:orgf65ab3f}Logos : Apache AGE, FerretDB, pg\_duck, Marten, Pongo}
\end{figure}
...
\label{sec:org0932d0c}
\subsection*{Compatibilité}
\label{sec:orgc8f84b8}
\begin{quote}
...
\label{sec:org2045d14}
\subsection*{Conformité et audit}
\label{sec:orgb041014}
\begin{description}
...
\caption{\label{fig:org3dd8e40}Logos : PGCat, pgBouncer, pgPool-II}
\end{figure}
...
\label{sec:org22971ef}
\subsection*{Mise en production}
\label{sec:org4f1cdff}
\begin{table}[H]
...
\caption{\label{fig:orgd29d069}Logos : Tembo, Neon, Supabase, Autobase, Omnigress}
\end{figure}
...
\caption{\label{fig:orgdb10547}Logos : Gel, pgEdge, Pigsty, iaSQL,}
\end{figure}
\subsection*{Analyse de compétitive}
\label{sec:orgd514a2a}
...
\label{sec:org7aa1ca9}
\section*{Evolution du document}
\label{sec:orgcf7f03e}
\begin{center}
\begin{tabular}{rl}
Date & Changements\\
\hline
